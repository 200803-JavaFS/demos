...
//	
	...
	public String logException(ProceedingJoinPoint pjp) throws Throwable{
		...
		log.info(a.getSupName() + " is about to throw down.");
		double dist = (double) pjp.getArgs()[2];
		if(dist<6) {
			log.warn(a.getSupName() + " is violating proper social distancing; so much for being a hero.");
			return "";
		} else {
